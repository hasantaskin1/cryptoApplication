...
//API'den dönen veriyi Kotlin uygulamanızda kullanabileceğiniz bir forma dönüştürür.
//Verinin nasıl yapılandırıldığını ve hangi bilgilere erişilebileceğini tanımlar.
