...
//Bu sınıf, bir kripto para biriminin Amerikan doları cinsinden piyasa verilerini
//temsil eden bir veri modelidir. Bu sınıf, kripto para biriminin piyasa değeri,
//fiyat değişim oranları, işlem hacmi gibi çeşitli finansal bilgileri içerir.
